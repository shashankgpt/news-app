      ...
      <div className="col-md-8 blog-main">
        ...
        <div className="blog-post">
          ...
          <p className="blog-post-meta">
            January 1, 2014 by <a href="w">Mark</a>
          </p>

          <p>
            This blog post shows a few different types of content that supported
            and styled with Bootstrap. Basic typography, images, and code are
            all supported.
          </p>
          <hr />
          <p>
            Cum sociis natoque penatibus et magnis{" "}
            <a href="w">dis parturient montes</a>, nascetur ridiculus mus.
        ...
        <div className="blog-post">
          ...
          <p className="blog-post-meta">
            December 23, 2013 by <a href="w">Jacob</a>
          </p>
        ...
        <div className="blog-post">
          ...
          <p className="blog-post-meta">
            December 14, 2013 by <a href="w">Chris</a>
          </p>
